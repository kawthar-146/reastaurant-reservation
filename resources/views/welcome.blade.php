<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('https://d1ralsognjng37.cloudfront.net/585a0b30-6088-4bcf-9aa9-3807316fc9c1.jpeg')">
        <h1
            ...
            <span class="inline md:block">Welcome To YummyFood</span>
        </h1>
            ...
            > -->
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="https://www.freepnglogos.com/uploads/chef-png/chef-share-alike-cooking-january-20.png" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        ...
                        src="https://media.istockphoto.com/vectors/restaurant-team-cartoon-vector-illustration-vector-id638704368?k=6&m=638704368&s=612x612&w=0&h=eAlIQEeGhfPGJIXVLra8SK1imDlT1Sh--Z8fLlUV8eM="
