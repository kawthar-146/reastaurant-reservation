...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-state-100 md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                ...
                <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto" style="background-image: url('https://apexembdesigns.com/sites/default/files/styles/image_600x600/public/2018-12/chef.jpg?itok=qWDYNCc6')">
